...
class Player:
    ...
    def draw(self):
        pygame.draw.circle(self.app.screen,(190,194,15),(int(self.pix_pos1.x),int(self.pix_pos1.y)),self.app.cell_width//2-2)
        pygame.draw.rect(self.app.screen,(255,0,0),(self.grid1_pos[0]*self.app.cell_width + TOP_BOTTOM_BUFFER//2,self.grid1_pos[1]*self.app.cell_height + TOP_BOTTOM_BUFFER//2,self.app.cell_width,self.app.cell_height),1)
        pygame.draw.circle(self.app.screen,(0,255,0),(int(self.pix_pos2.x),int(self.pix_pos2.y)),self.app.cell_width//2-2)
        pygame.draw.rect(self.app.screen,(255,0,0),(self.grid2_pos[0]*self.app.cell_width + TOP_BOTTOM_BUFFER//2,self.grid2_pos[1]*self.app.cell_height + TOP_BOTTOM_BUFFER//2,self.app.cell_width,self.app.cell_height),1)
        ...
        for x in range(self.lives_2):
            pygame.draw.circle(self.app.screen, PLAYER_COLOUR,
                               (230 + 20 * x, HEIGHT - 15), 7)


        # Drawing the grid pos rect
        # pygame.draw.rect(self.app.screen, RED, (self.grid1_pos[0]*self.app.cell_width+TOP_BOTTOM_BUFFER//2,
        #                                         self.grid2_pos[1]*self.app.cell_height+TOP_BOTTOM_BUFFER//2, self.app.cell_width, self.app.cell_height), 1)
